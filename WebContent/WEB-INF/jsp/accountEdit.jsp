...
<body>
  <div class="main">
    ...
    <div class="navHeading">
      ...
      <c:if test="${currUser.role != 'ROLE_COMP'}">
      <tr>
        <td width="70%">Max Available:</td>
    		<td width="30%">
    		<font color="red" size="3">
                   		<fmt:formatNumber value="${currUser.account.playerRoyalty}"
      ...
      <tr>
    	<td width="70%">Banker Royalty (%)</td>
        <td width="30%">
          <input type="text" name="command.newAccount.bankerRoyalty" size="10px"
      ...
      <tr>
        <td width="70%">Max Available:</td>
    		<td width="30%">
    		<font color="red" size="3">
                   		<fmt:formatNumber value="${currUser.account.bankerRoyalty}"
    							 type="number" maxFractionDigits="2" minFractionDigits="2" />
        </font>
    		</td>
      </tr>
