...
<html>
<head>
  <title>accountDistributionEdit</title>
...
<body>
  <div class="main">
    <form:form method="post" id="myForm" action="../acc/processAccount.html" modelAttribute="accountDistributionForm" >
    ...
    <div class="headerPic">
        ...
        ${currUser.role.desc}&nbsp; ${currUser.contact} - Maintain Distributions for ${currAccountUser.role.desc} ${currAccountUser.contact}
			</h2>
		</div>
    <div class="navHeading">
      ...
      <tbody align="left" style="color:purple; background-color:${currAccountUser.role.color}">
      <tr>
    	<td width="70%">Player Distribution</td>
    		<td width="30%"><input type="text" name="command.playerDistribution" size="10px"
    		value="${accountDistributionForm.prevCommand.playerDistribution}" />
    		</td>
    	</tr>
      <tr>
      ...
      <tr>
        <tr>
      	<td width="70%">Banker Distribution</td>
        <td width="30%"><input type="text" name="command.bankerDistribution" size="10px"
                value="${accountDistributionForm.prevCommand.bankerDistribution}" />
        </td>
      <tr>
        <tr>
    ...
    <tr><td><font color="red" size="3">${accountDistributionForm.message}</font></td></tr>
    <br/>
    <table border="0" cellpadding="3" cellspacing="0" width="300">
    <tbody align="left" >
    <tr style="background-color:#333;">
    	<td><input type="submit" name="saveDistribution" value="Save" style="height:23px;"/></td>
    </tr>
    </tbody>
    </table>
    </form:form>
